...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20251205175238_AddNeighborhoodEdgeTable")]
    partial class AddNeighborhoodEdgeTable
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Neighborhoods.NeighborhoodEdge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasIndex("FromNeighborhoodId");

                    b.HasIndex("ToNeighborhoodId");

                    b.ToTable("NeighborhoodEdge", (string)null);
                });
            ...
            modelBuilder.Entity("Domain.Neighborhoods.NeighborhoodEdge", b =>
                {
                    b.HasOne("Domain.Neighborhoods.Neighborhood", null)
                        .WithMany()
                        .HasForeignKey("FromNeighborhoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();

                    b.HasOne("Domain.Neighborhoods.Neighborhood", null)
                        .WithMany()
                        .HasForeignKey("ToNeighborhoodId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                });

...
namespace Infrastructure.Migrations
{
    ...
    [Migration("20260410162454_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.Conversations.Message", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.Conversations.Participant", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.LoanTransactions.LoanTransaction", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<DateTimeOffset?>("PickupCompletedAt")
                        .HasColumnType("datetimeoffset");

                    b.Property<DateTimeOffset?>("ReturnCompletedAt")
                        .HasColumnType("datetimeoffset");
            ...
            modelBuilder.Entity("Domain.LoanTransactions.QrToken", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.LoanTransactions.LoanTransaction", b =>
                {
                    b.HasOne("Domain.BorrowRequests.BorrowRequest", null)
                        .WithOne()
                        .HasForeignKey("Domain.LoanTransactions.LoanTransaction", "BorrowRequestId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .IsRequired();
                    ...
                    b.OwnsOne("Domain.Shared.ValueObjects.TimeSlot", "LoanPeriod", b1 =>
                        {
                            b1.Property<Guid>("LoanTransactionId")
                                .HasColumnType("uniqueidentifier");
                            ...
                            b1.HasKey("LoanTransactionId");

                            b1.ToTable("LoanTransaction");

                            b1.WithOwner()
                                .HasForeignKey("LoanTransactionId");
                        });

                    b.OwnsOne("Domain.Shared.ValueObjects.Geolocation", "PickupLocation", b1 =>
                        {
                            b1.Property<Guid>("LoanTransactionId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("Domain.Shared.ValueObjects.Geolocation", "ReturnLocation", b1 =>
                        {
                            b1.Property<Guid>("LoanTransactionId")
                                .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("Domain.LoanTransactions.QrToken", b =>
                {
                    b.HasOne("Domain.LoanTransactions.LoanTransaction", null)
                        .WithMany("QrTokens")
                        .HasForeignKey("LoanTransactionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

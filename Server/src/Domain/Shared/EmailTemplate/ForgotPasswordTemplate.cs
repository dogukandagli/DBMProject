...
public sealed class ForgotPasswordTemplate : IEmailTemplate
{
    private readonly string UserName;
    private readonly string ResetPasswordUrl;
    public ForgotPasswordTemplate(string userName, string resetPasswordUrl)
    {
        UserName = userName;
        ResetPasswordUrl = resetPasswordUrl;
    }

    public string GetSubject() => "Şifre Sıfırlama";
                        ...
                        <td>
                            <div class=""container"">
                                ...
                                <div class=""footer"">
                                    ...
                                    © 2025 DBMProject - Tüm hakları saklıdır.
                                </div>
                            </div>
                        </td>
                    </tr>
